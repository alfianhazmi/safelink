...
if(x=="10"){xxx="what-is-meaning-of-blockchain.html"}
if(x=="11"){xxx="6-features-of-good-4k-portable-monitor.html"}
if(x=="12"){xxx="5-ways-to-extend-your-android.html"}
if(x=="13"){xxx="armored-landcruiser-200-series.html"}
if(x=="14"){xxx="how-to-start-your-online-travel-business.html"}
...
if(x=="25"){xxx="red-gold-apple.html"}
if(x=="26"){xxx="how-to-use-google-adwords-for-business.html"}
if(x=="27"){xxx="higher-education-marketing-digital.html"}
if(x=="28"){xxx="how-to-use-call-to-action-for-better.html"}
if(x=="29"){xxx="what-is-market-research-why-is-it.html"}
if(x=="30"){xxx="everything-about-all-new-bmw-x3.html"}a_to_ve[i].href="https://direct.mah-channel.my.id/2021/08/"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
